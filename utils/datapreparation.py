...
def RPRV_Parihaka(shape=(992,192),stridetest=(128,64), strideval=(128,64), stridetrain=(128,64), sizetrain_x=192, sizetrain_y=192, test_pos='end'):
    read_seis_data = np.load(
        '/scratch/nunes/seismic/data_train.npz', 
                allow_pickle=True, mmap_mode = 'r')
    # We read our labels
...
def RPEDS_Parihaka(shape=(992,192),stridetest=(128,64), strideval=(128,64), stridetrain=(128,64), sizetrain_x=192, sizetrain_y=192,num_extra_train=1):
    read_seis_data = np.load(
    '/scratch/nunes/seismic/data_train.npz', 
            allow_pickle=True, mmap_mode = 'r')
    # We read our labels
...
def penobscot_limited_data(shape=(992,192),stridetest=(128,64), strideval=(128,64), stridetrain=(128,64), sizetrain_x=192,sizetrain_y=192, test_pos='end'):
...
def penobscot_RPRV_Parihaka_fixed_test_val(shape=(992,192),stridetest=(128,64), strideval=(128,64), stridetrain=(128,64), sizetrain_x=192, sizetrain_y=192, test_pos='end',max_sizetrain_x=320,max_sizetrain_y=270):
    seis_data, labels=read_h5_file('/scratch/nunes/seismic/penobscot.h5')
    seis_data=scale_to_256(seis_data)
    seis_data=seis_data.astype(np.uint8)
...
def RPEDS_Penobscot(shape=(992,192),stridetest=(128,64), strideval=(128,64), stridetrain=(128,64), sizetrain_x=192, sizetrain_y=192,num_extra_train=1):
    seis_data, labels=read_h5_file('/scratch/nunes/seismic/penobscot.h5')
    seis_data=scale_to_256(seis_data)
    seis_data=seis_data.astype(np.uint8)
...
def RPRV_Penobscot(shape=(992,192),stridetest=(128,64), strideval=(128,64), stridetrain=(128,64), sizetrain_x=192, sizetrain_y=192, test_pos='end'):
    images, masks=read_h5_file('/scratch/nunes/seismic/penobscot.h5')
    images=scale_to_256(images)
    images=images.astype(np.uint8)
