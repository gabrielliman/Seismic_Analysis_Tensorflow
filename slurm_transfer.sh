...
#treinando primeiro
conda run -n seismic_tf python ./train_transfer.py -m 3 --name "2601_aerial" -o 0 -g 3.6 -s1 496 -s2 192 --stridetrain 64 --delta 1e-5 --patience 5 --loss_function 1 --folder "2601_aerial_train" --epochs 100 --dataset 1 -b 4 -k 3 --dropout 0.5 --pre_classes 6

conda run -n seismic_tf python ./train_transfer.py -m 3 --name "2601_transfer_aerial" -o 0 -g 3.6 -s1 992 -s2 192 --stridetrain 100 --delta 1e-5 --patience 5 --loss_function 1 --folder "2601__aerial_transfer_results" --epochs 100 --dataset 0 -b 4 -k 3 --weights_path "./checkpoints/2601_aerial_train/checkpoint_2601_aerial.h5" --dropout 0.5 --pre_classes 6 --classes 6
