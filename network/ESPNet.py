...
def ESPNet(height,width,channels, num_classes):
    ...
    deconv3 = conv_one_cross_one(deconv3, num_classes)  # Change to nclasses
    deconv3 = Activation('softmax')(deconv3)  # Change to softmax for multi-class
